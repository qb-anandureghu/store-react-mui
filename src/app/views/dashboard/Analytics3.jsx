      ...
      <Grid container spacing={3}>
        <Grid sx={{mt: 4}} item xs={12}>
          <H3 sx={{fontSize: '1.25rem'}}>
            Most{' '}
            <Span sx={{fontSize: '.9375rem', color: colorPrimary}}>
              Recent Media
            </Span>
          </H3>
        </Grid>
...
const mostRecentMedia = [
  {
    ...
    imgUrl:
      'https://arctic.ui-lib.com/preview/layout1/assets/images/gallery/sq-10.jpg',
  },
  {
    like: '2.3K',
    comment: 900,
    uploadDate: '23 days ago',
    imgUrl:
      'https://arctic.ui-lib.com/preview/layout1/assets/images/gallery/sq-8.jpg',
  },
  {
    like: '2.3K',
    comment: 900,
    uploadDate: '23 days ago',
    imgUrl:
      'https://arctic.ui-lib.com/preview/layout1/assets/images/gallery/sq-6.jpg',
  },
  {
    like: '2.3K',
    comment: 900,
    uploadDate: '23 days ago',
    imgUrl:
      'https://arctic.ui-lib.com/preview/layout1/assets/images/gallery/sq-4.jpg',
  },
];
